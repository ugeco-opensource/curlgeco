...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-[90vw] max-w-2xl translate-x-[-50%] translate-y-[-50%] gap-4 rounded-[var(--ugeco-radius)] border border-white/10 bg-[#0b1224] p-6 shadow-2xl",
        className
      )}
      {...props}
    >
