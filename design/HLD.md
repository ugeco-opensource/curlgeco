...
- Packaging: standalone Next.js build in the root `Dockerfile`
- Local runtime: root `docker-compose.yml`
- Cluster target: UGECO AKS
- Ingress host: `curlgeco.ugeco.in`
- Ingress class: `nginx`
- Certificate issuer: `letsencrypt-ugeco-dns`
- Chart location: `deployment/charts/curlgeco`

## Infra boundary
- Shared platform concerns remain in `ugeco-infra/`:
  - public ingress controller values
  - Azure DNS for `ugeco.in`
  - cert-manager Azure DNS cluster issuer
  - Argo CD and private admin tooling
